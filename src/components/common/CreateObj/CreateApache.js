...
var CreateApache = React.createClass({
    ...
    _click: function () {
        ...
        apacheData['applicationName']=applicationName;
        apacheData['ip']=ip;
        console.log(apacheData);
        AppServiceAction.createAppService(apacheData);
    },
            ...
            <div style={{backgroundColor:"white",padding:"3px 0 30px 0"}}>
                ...
                <Form horizontal>
                    <FormGroup>
                        ...
                        <Col sm={2}>
                            <FormControl ref="applicationName" controlId="applicationName" defaultValue="apache" readOnly/>
                        </Col>
                    </FormGroup>
                    <FormGroup>
                        <Col componentClass={ControlLabel} sm={1}>
