...
var CreateSqlServer = React.createClass({
    ...
    _click: function () {
        ...
        sqlServerData['applicationName']=applicationName;
        sqlServerData['ip']=ip;
        console.log(sqlServerData);
        DatabasesAction.createDatabase(sqlServerData);
    },
...
module.exports = CreateSqlServer;